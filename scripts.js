...
const botao_pesquisar = document.getElementById("pesquisar_botao");
...
function criar_tabela() {
    ...
    novaTarefaBtn.classList.add("acoes_tarefas");
    ...
    for (let contador = 0; contador < tarefas.length; contador++) {
        ...
        if (contador >= 0) {
            ...
            editarBotao.classList.add("acoes_tarefas");
            ...
            excluirBotao.classList.add("acoes_tarefas");
            ...
            finalizaBotao.classList.add("acoes_tarefas");
